...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="Stellar-master/vendors/daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="Stellar-master/vendors/chartist/chartist.min.css">
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="Stellar-master/css/style.css">
    <!-- End layout styles -->
...
-->
              ...
              <div class="col-12 stretch-card grid-margin">
                <div class="card card-secondary">
                  <span class="card-body d-lg-flex align-items-center">
                    <p class="mb-lg-0">Show a dismissable popup! </p>
                    <a href="{{route('home')}}" target="_blank" class="btn btn-warning purchase-button btn-sm my-1 my-sm-0 ml-auto">Go Somewhere</a>
    ...
    <script src="Stellar-master/vendors/chart.js/Chart.min.js"></script>
    ...
    <script src="Stellar-master/vendors/chartist/chartist.min.js"></script>
