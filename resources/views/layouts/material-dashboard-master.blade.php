...
<link id="pagestyle" href="material-dashboard-master/assets/css/material-dashboard.css?v=3.0.4" rel="stylesheet" />
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
      ...
      <span class="ms-1 font-weight-bold text-white"> {{env('APP_DISPLAYNAME')}}</span>
    </a>
  </div>
  ...
  <hr class="horizontal light mt-0 mb-2">
      ...
      <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link text-white " href="{{ __('Logout') }}"
  ...
  <div class="sidenav-footer position-absolute w-100 bottom-0 ">
    <div class="mx-3">
      <a class="btn bg-gradient-primary mt-4 w-100" href="" type="button">Secret</a>
    </div>
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                              <div class="d-flex py-1">
                                <div class="my-auto">
                                  <img src="material-dashboard-master/assets/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                                </div>
                                <div class="d-flex flex-column justify-content-center">
                                  <h6 class="text-sm font-weight-normal mb-1">
                                    <span class="font-weight-bold">New message</span> {{ $m->sender ?? "Someones Nmae"}}
                                  </h6>
                                  <p class="text-xs text-secondary mb-0">
                                    <i class="fa fa-clock me-1"></i>
                                    {{ $m->created_at ?? "Some "}} minutes ago
                                  </p>
                                </div>
                              </div>
                            </a>
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="material-dashboard-master/assets/js/material-dashboard.min.js?v=3.0.4"></script>
  </body>
